...
(function(SAT) {
  ...
  Polygon.prototype.pointsArray = function()
  {
    var normalArray = [];
    for(i in this.points)
    {
      normalArray.push(this.points[i].x);
      normalArray.push(this.points[i].y);
    }
    return normalArray;
  };
  Polygon.prototype['pointsArray'] = Polygon.prototype.pointsArray;
